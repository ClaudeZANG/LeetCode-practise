...
//         Arrays.sort(citations);  // Sort in ascending order first
//         int n = citations.length;
        
//         for (int i = 0; i < n; i++) {
//             int h = n - i;  // Calculate the current h value (number of papers)
//             if (citations[i] >= h) {
//                 return h;
//             }
//         }
