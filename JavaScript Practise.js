...
// re-write 2025/Mar/1 - 1
// var maxProfit = function(prices) {  // 'maxProfit' is method
//     let maxProfit = 0;              // 'maxProfit' is variable. JavaScript allows use same name.
//     for (let i = 1; i < prices.length; i++) {
//         maxProfit += Math.max(prices[i] - prices[i - 1], 0);
//     }
//     return maxProfit;
...
// # re-write 2025/Mar/8 - 3 / add space between'function' and '()'
// var hIndex = function (citations) {
//     citations.sort((a, b) => a - b);
//     let n = citations.length;
...
class RandomizedSet {
    ...
    remove(val) {
        ...
        // Replace the element to be deleted
